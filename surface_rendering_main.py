...
def train_points(
    ...
    for epoch in range(0, cfg.training.num_epochs):
        ...
        for idx in t_range:
            ...
            loss = torch.mean(distances_square) 
            point_loss = loss
...
def train_images(
    ...
    for epoch in range(start_epoch, cfg.training.num_epochs):
        ...
        if (
            ...
            imageio.mimsave('images/part_8_beta_20_images.gif', [np.uint8(im * 255) for im in test_images])
            ...
            try:
                ...
                imageio.mimsave('images/part_8_geometry_20_images.gif', [np.uint8(im * 255) for im in test_images])
            except Exception as e:
                print("Empty mesh")
                pass
